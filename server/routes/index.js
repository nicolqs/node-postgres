...
router.post('/api/v1/users', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        client.query("INSERT INTO users(username, email) values($1, $2)", [data.username, data.email]);
...
router.put('/api/v1/users/:user_id', function(req, res) {
    ...
    pg.connect(connectionString, function(err, client, done) {
        ...
        client.query("UPDATE users SET username=($1), email=($2) WHERE id=($3)", [data.username, data.email, id]);
